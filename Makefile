...
build-release:
	...
	strip target/x86_64-unknown-linux-musl/release/snapper
	chmod u+s target/x86_64-unknown-linux-musl/release/snapper
...
bundle-base: build-release
	...
	cp target/x86_64-unknown-linux-musl/release/snapper /tmp/snapper
