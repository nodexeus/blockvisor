...
//         ips: vec![common::IpName {
//             ip: "192.167.0.1/24".to_string(),
//             name: None,
//         }],
//         ports: vec![
//             common::PortName {
...
//         description: None,
//     }];
//     let properties = vec![common::ImagePropertyValue {
//         key: "TESTING_PARAM".to_string(),
...
//                         host_id,
//                         host_name: "".to_string(),
//                         host_org_id: "".to_string(),
//                         blockchain_id: "".to_string(),
//                         blockchain_name: "".to_string(),
//                         blockchain_version_id: "".to_string(),
...
//                     id: id.clone(),
//                     auto_upgrade: None,
//                     new_org_id: Some("org-id".to_string()),
//                     new_org_name: None,
//                     new_name: None,
//                     new_note: None,
//                     new_properties: vec![],
//                     firewall_rules: Some(common::FirewallRules {
//                         rules: Some(vec![common::FirewallRule {
//                             key: "Rule B".to_string(),
//                             action: common::FirewallAction::Allow.into(),
//                             direction: common::FirewallDirection::Inbound.into(),
...
//                     new_properties: vec![],
//                     firewall_rules: Some(common::FirewallRules {
//                         rules: Some(common::FirewallRules {
...
//                     new_note: None,
//                     new_properties: vec![common::ImagePropertyValue {
//                         key: "new_key".to_string(),
//                         value: "New Value".to_string(),
//                     }],
//                     firewall_rules: Some(common::FirewallRules {
//                         rules: Some(vec![common::FirewallRule {
//                             key: "Rule A".to_string(),
//                             action: common::FirewallAction::Allow.into(),
//                             direction: common::FirewallDirection::Inbound.into(),
//                             protocol: Some(common::FirewallProtocol::Tcp.into()),
//                             ips: vec![common::IpName {
//                                 ip: "192.168.0.1/24".to_string(),
//                                 name: None,
//                             }],
//                             ports: vec![
//                                 common::PortName {
