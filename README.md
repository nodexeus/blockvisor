...
Manually trigger GH [release action](https://github.com/blockjoy/blockvisor/actions/workflows/release.yaml) or: 
...
- `/etc/blockvisor.toml` generated by `bvup <OTP>`, but can be later modified
...
sequenceDiagram
    ...
    frontend-->>user: bvup with OTP
    user->>host: run bvup with OTP
